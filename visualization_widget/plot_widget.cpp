...
PlotWidget::PlotWidget(QWidget *widget):
    QCustomPlot(0),
...
int PlotWidget::addNewGraph(const QString &name, const QColor &line_color, const QColor &dot_color)
{
    //set line info
...
void PlotWidget::removeAllGraph()
{
    this->clearGraphs();
    this->replot();
}

void PlotWidget::setData(const int line_id, double x, double y)
{
    int dot_id = line_id+1 ;
...
void PlotWidget::titleDoubleClick()
{
    bool ok;
...
void PlotWidget::on_axisLabelDoubleClick(QCPAxis *axis, QCPAxis::SelectablePart part)
{
...
void PlotWidget::on_legendDoubleClick(QCPLegend *legend, QCPAbstractLegendItem *item)
{
    Q_UNUSED(legend)
    if (item)
    {
...
void PlotWidget::on_selectionChanged()
{
...
void PlotWidget::on_actionGroupTriggered(QAction *target_action)
{
    target_action->setCheckable(true);
    target_action->setChecked(true);
}

void PlotWidget::on_action_control_triggered()
{

}

void PlotWidget::on_action_remove_triggered()
{

}

void PlotWidget::on_action_addLine_triggered()
{

}

void PlotWidget::on_action_legend_move()
{
...
void PlotWidget::init_SignalSlot()
{
